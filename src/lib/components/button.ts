...
export const BUTTON_SECONDARY = `${SHAPE} border border-slate-500 bg-white/70 text-slate-800 hover:bg-white dark:border-slate-400 dark:bg-white/5 dark:text-slate-100 dark:hover:bg-white/10`;
