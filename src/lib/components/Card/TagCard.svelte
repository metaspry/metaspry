...
>
  <p class="text-[10px] font-semibold uppercase tracking-wider ms-muted break-all">
    {tag.key}
  </p>
  ...
  <div class="absolute right-1 top-1 flex items-center gap-0.5">
    ...
    <button
      ...
      class="flex h-7 w-7 items-center justify-center rounded-lg ms-muted transition hover:bg-white/60 hover:text-indigo-600 dark:hover:bg-white/10 dark:hover:text-indigo-300"
    >
